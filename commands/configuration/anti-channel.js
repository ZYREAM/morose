...
module.exports = {
    ...
    async execute(client, message, args, droit) {
        ...
        if(args[0] === "on"){
            ...
            const droit = new Discord.MessageEmbed()
            .setColor('#9b9b9b')
                .setDescription("<a:oui:873277851695206401> La création de channel est désormais interdite");
                message.lineReplyNoMention(droit);
        }else if(args[0] === "off"){
            srv.set(`${message.guild.id}`, "off", "antipub");
            const droit = new Discord.MessageEmbed()
            .setColor('#9b9b9b')
                .setDescription("<a:oui:873277851695206401> La création de channel est désormais autorisée");
                message.lineReplyNoMention(droit);
        }else {
            const droit = new Discord.MessageEmbed()
            .setColor('#9b9b9b')
